        ...
        >
          ...
          <div>
            ...
            <p class="mt-1 font-semibold text-slate-700 dark:text-slate-200">
              ...
              <span class="ml-1 text-xs font-medium text-brand-600 dark:text-brand-400">{{ formatCurrencyLKR(line.price) }}</span>
            </p>
          </div>
        ...
        <dl class="mt-4 space-y-2 text-sm">
          ...
          <div class="flex items-center justify-between">
            ...
            <dd class="text-right">
              ...
              <span class="ml-1 text-xs text-brand-600 dark:text-brand-400">{{ formatCurrencyLKR(cartStore.subtotal) }}</span>
            </dd>
          </div>
          <div class="flex items-center justify-between">
            <dt class="text-slate-600 dark:text-slate-300">Shipping</dt>
            <dd class="text-right">
              <span class="font-semibold">{{ formatCurrency(shipping) }}</span>
              <span class="ml-1 text-xs text-brand-600 dark:text-brand-400">{{ formatCurrencyLKR(shipping) }}</span>
            </dd>
          </div>
          <div class="flex items-center justify-between">
            ...
            <dd class="text-right">
              ...
              <span class="ml-1 text-xs text-brand-600 dark:text-brand-400">{{ formatCurrencyLKR(tax) }}</span>
            </dd>
          </div>
          ...
          <div class="flex items-center justify-between text-base">
            ...
            <dd class="text-right">
              ...
              <p class="text-sm font-medium text-brand-600 dark:text-brand-400">{{ formatCurrencyLKR(total) }}</p>
            </dd>
          </div>
        </dl>
